...
PLS model using the full spectral signature (240 wavelengths)

PLS_VIP

Variable selection using VIP threshold ≥ 1

PLS_BVE

Backward Variable Elimination algorithm based on absolute regression coefficients

PLS_GSMW

Grid Search Moving Window algorithm for identifying optimal wavelength windows
...
The BVE-PLS model achieved:

similar accuracy to full-spectrum PLS
using less than one quarter of wavelengths
